...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/boot/2ndboot.bin:2ndbootloader

################################################################################
# init
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/init.s5p4418_navi_ref.rc:root/init.s5p4418_navi_ref.rc \
	device/nexell/s5p4418_navi_ref/init.s5p4418_navi_ref.usb.rc:root/init.s5p4418_navi_ref.usb.rc \
	device/nexell/s5p4418_navi_ref/init.recovery.s5p4418_navi_ref.rc:root/init.recovery.s5p4418_navi_ref.rc \
	device/nexell/s5p4418_navi_ref/fstab.s5p4418_navi_ref:root/fstab.s5p4418_navi_ref \
	device/nexell/s5p4418_navi_ref/ueventd.s5p4418_navi_ref.rc:root/ueventd.s5p4418_navi_ref.rc \
	device/nexell/s5p4418_navi_ref/adj_lowmem.sh:root/adj_lowmem.sh \
	device/nexell/s5p4418_navi_ref/start_deferred.sh:root/start_deferred.sh \
	device/nexell/s5p4418_navi_ref/mon_snd.sh:root/mon_snd.sh

################################################################################
# recovery
################################################################################
PRODUCT_COPY_FILES += \
    device/nexell/s5p4418_navi_ref/busybox:busybox \
    device/nexell/s5p4418_navi_ref/wipe_data.sh:wipe_data.sh \
    device/nexell/s5p4418_navi_ref/wipe_cache.sh:wipe_cache.sh

################################################################################
# key
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/keypad_s5p4418_navi_ref.kl:system/usr/keylayout/keypad_s5p4418_navi_ref.kl \
	device/nexell/s5p4418_navi_ref/keypad_s5p4418_navi_ref.kcm:system/usr/keychars/keypad_s5p4418_navi_ref.kcm

################################################################################
# touch
################################################################################
PRODUCT_COPY_FILES += \
    device/nexell/s5p4418_navi_ref/tsc2007.idc:system/usr/idc/tsc2007.idc 
...
################################################################################
#PRODUCT_COPY_FILES += \
	#device/nexell/s5p4418_navi_ref/vold.fstab:system/etc/vold.fstab
...
# mixer paths
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/audio/tiny_hw.s5p4418_navi_ref.xml:system/etc/tiny_hw.s5p4418_navi_ref.xml
# audio policy configuration
ifeq ($(EN_DUAL_AUDIO_PATH_SPDIF),true)
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/audio/audio_policy_disable_spdif.conf:system/etc/audio_policy.conf
else
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/audio/audio_policy.conf:system/etc/audio_policy.conf
endif
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/s5p4418_navi_ref/media_profiles.xml:system/etc/media_profiles.xml
...
################################################################################
#PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/bcmdhd.cal:/system/etc/wifi/bcmdhd.cal \
	device/nexell/s5p4418_navi_ref/wl:/system/bin/wl
...
#PRODUCT_COPY_FILES += \
#	device/nexell/s5p4418_navi_ref/gps/u-blox/u-blox.conf:system/etc/u-blox.conf
...
################################################################################
#PRODUCT_COPY_FILES += \
  #device/nexell/s5p4418_navi_ref/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_navi_ref/busybox-armv7l:system/bin/busybox-armv7l \
	device/nexell/s5p4418_navi_ref/memtester1-1:system/bin/memtester1-1 \
	device/nexell/s5p4418_navi_ref/hwreg_cmd:system/bin/hwreg_cmd
...
DEVICE_PACKAGE_OVERLAYS := \
	device/nexell/s5p4418_navi_ref/overlay
...
PRODUCT_PACKAGES += \
    VolantisLayouts5p4418_navi_ref
...
# $(call inherit-product-if-exists, device/nexell/s5p4418_navi_ref/tiny_gapps.mk)
